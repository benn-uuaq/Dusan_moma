...
REGISTERS = [
    ...
    ("260 ~ 263", "반지름 / 두께 / 프로브 가로·세로 커버", "W", "0.1 mm",
     "시작할 때 한 번만 읽는다 — 그 뒤 260~265 는 TCP 가 덮어쓴다"),
    ...
    ("306 / 307", "작업 속도 / 속도 비율", "W", "mm/s · %", "상한 150 mm/s"),
